	...
	<body>
	    ...
	    <div class="row justify-content-center">
	        ...
	        <div class="col-4 align-items-center">
	            <h5 class="align-self-center text-info" id="titel">L'interface de recherche pour les élèves </h5>
	        </div>
	        <div class="col-2"></div>
	        <div class="col-2 ">
	                 ...
	                 <div class="card-body">
		               <form action="controleur" method="post" >
	                       <div class="row justify-content-start">
	                         <div class="col-4">
	                            <input type="text" name="motCle" value="${modele.motCle}" class="form-control" id="inputMcl" placeholder="Entrer un nom de livre">
	                          </div>
	                         <div class="col-1 align-self-start">
	                             <button id="buttonId" type="submit" value="OK" class="btn btn-outline-info">OK</button>
	                         </div>
	                         <div class="col-7"></div>
